...
| Community | Tickets/replies/close, ticket categories, application forms/submit/review, welcome message and local role assignment, reminders | Live ticket-channel verification, real welcome role buttons and notification routing. Private ticket-channel plans/CLI adapter and applicant-scoped views are implemented |
